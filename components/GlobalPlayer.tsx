...
export const GlobalPlayer: React.FC<GlobalPlayerProps> = ({ onExpand, onClose }) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="max-w-7xl mx-auto bg-[#080808]/98 backdrop-blur-3xl border border-neutral-800 p-4 md:p-8 rounded-none flex flex-col md:flex-row items-center gap-4 md:gap-8 shadow-[0_-40px_80px_rgba(0,0,0,0.8)] pointer-events-auto relative overflow-hidden">
          ...
          <div className="flex-grow w-full md:w-1/2 flex flex-col items-center gap-3 md:gap-4 px-0 md:px-4">
