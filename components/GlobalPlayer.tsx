...
const ProgressSlider: React.FC = () => {
  ...
  return (
    <div className="w-full flex items-center gap-4">
      ...
      >
        <div 
          className="absolute inset-0 h-full bg-[#FF007F] shadow-[0_0_10px_rgba(255,0,127,0.5)] transition-all duration-300 ease-out"
          style={{ width: `${percent}%` }}
        />
...
export const GlobalPlayer: React.FC = () => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="max-w-6xl mx-auto bg-[#050505]/90 backdrop-blur-3xl border border-white/5 p-4 md:p-6 rounded-none flex flex-col md:flex-row items-center gap-6 shadow-[0_-30px_60px_rgba(0,0,0,0.9)] pointer-events-auto overflow-hidden">
          ...
          <div className="flex-grow w-full md:w-1/2 flex flex-col items-center gap-3">
            <div className="flex items-center gap-8 text-neutral-400">
              <SkipBack size={20} className="opacity-20 cursor-not-allowed" />
              ...
              {!currentSong.video_url ? (
                ...
                <button 
                  className="w-14 h-14 rounded-full bg-white flex items-center justify-center text-black hover:scale-105 active:scale-95 transition-all cursor-pointer shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                  onClick={togglePlay}
                >
              ...
              <SkipForward size={20} className="opacity-20 cursor-not-allowed" />
            </div>
